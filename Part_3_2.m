...
%write the data
audiowrite("alpha=1 OLA.wav", y_ola, fs);
audiowrite("alpha=1 SWOLA regular.wav", y_wsola, fs);
audiowrite("alpha=1 SWOLA stattur.wav", y_wsola2, fs);
audiowrite("alpha=1 SWOLA skiping.wav", y_wsola3, fs);
